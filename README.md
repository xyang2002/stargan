...
**You can run the code directly [here](https://www.kaggle.com/code/xyang2002/star-gan). We have modified some errors that existed in the original training process.**
